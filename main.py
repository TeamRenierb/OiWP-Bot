...
async def cmd_start(update: Update):
    bot.send_message(
        ...
        text=f"Hello {update.effective_user.full_name} 👋🏻<br>Please send the phone number you want to chat with including country code",
    )
...
async def cmd_help(update: Update):
    bot.send_message(
        chat_id=update.effective_chat.id,
        text="You can send the phone number you want to chat with <b>including international code</b> (eg +917419651046)",
